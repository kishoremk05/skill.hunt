  ...
  return (
    <div className="space-y-6 text-left">
      ...
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1 font-semibold">Manage project collaborators and team directories.</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
          ...
          <div className="xl:col-span-5 bg-white rounded-2xl border border-slate-300 shadow-sm p-6 sm:p-8 space-y-6">
            <div>
              <h3 className="text-sm font-extrabold text-slate-800 uppercase tracking-widest border-b border-slate-100 pb-3">Add Collaborator</h3>
              <p className="text-[10px] text-slate-450 mt-1.5 font-semibold leading-relaxed">Register a new student member for "{projectTitle}".</p>
            </div>
            ...
            <form onSubmit={handleAddMember} className="space-y-4">
              ...
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl text-xs font-bold text-white bg-black hover:bg-[#222222] transition-all shadow-sm disabled:opacity-50 mt-2 uppercase tracking-wider"
              >
          ...
          <div className="xl:col-span-7 bg-white rounded-2xl border border-slate-300 shadow-sm p-6 sm:p-8 space-y-6">
            <div>
              <h3 className="text-sm font-extrabold text-slate-800 uppercase tracking-widest border-b border-slate-100 pb-3">Active Roster</h3>
              <p className="text-[10px] text-slate-455 mt-1.5 font-semibold leading-relaxed">Roster of registered authors for this showcase project.</p>
            </div>

            {members.length === 0 ? (
              <div className="p-8 text-center text-slate-450 border border-slate-200 rounded-2xl bg-slate-50/20">
                <p className="text-sm font-bold text-slate-700">Just You!</p>
                <p className="text-xs text-slate-500 mt-1 font-semibold leading-relaxed">You are currently the sole owner and developer. Add collaborators on the left.</p>
              </div>
            ) : (
              <div className="space-y-3">
                {members.map((member) => (
                  <div
                    key={member.id}
                    className="flex items-center justify-between p-4 rounded-xl border border-slate-200 bg-white hover:border-slate-350 transition-all shadow-sm"
                  >
                    <div className="flex items-center gap-3.5 min-w-0">
                      <div className="w-10 h-10 rounded-xl bg-slate-50 text-slate-655 font-extrabold flex items-center justify-center border border-slate-200 shrink-0">
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl text-slate-400 hover:text-red-500 hover:bg-slate-50 transition-all shrink-0"
                    >

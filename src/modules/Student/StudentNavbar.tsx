...
export default function StudentNavbar({ isCollapsed }: { isCollapsed: boolean }) {
  ...
  return (
    <header
      className={`fixed top-0 right-0 left-0 md:left-auto z-40 h-16 bg-[#121212]/95 backdrop-blur-xl border-b border-white/12 flex items-center justify-between px-5 transition-all duration-300 ease-in-out ${
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="hidden sm:block text-left">
              ...
              <p className="text-[10px] text-white/40 font-semibold uppercase tracking-wide">Student</p>
            </div>
            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-52 bg-[#1a1a1a] border border-white/12 rounded-2xl shadow-2xl shadow-black/50 py-1.5 z-20">
                <div className="px-4 py-3 border-b border-white/12 mb-1">
                  ...
                  <p className="text-[10px] text-white/40 mt-0.5">Student Account</p>
                </div>
